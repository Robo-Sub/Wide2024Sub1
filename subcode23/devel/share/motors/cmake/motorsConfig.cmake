...
if("TRUE" STREQUAL "TRUE")
  set(motors_SOURCE_PREFIX /home/robosub/subcode23/src/motors)
  set(motors_DEVEL_PREFIX /home/robosub/subcode23/devel)
  set(motors_INSTALL_PREFIX "")
  set(motors_PREFIX ${motors_DEVEL_PREFIX})
else()
  set(motors_SOURCE_PREFIX "")
  set(motors_DEVEL_PREFIX "")
  set(motors_INSTALL_PREFIX /home/robosub/subcode23/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robosub/subcode23/src/motors/${idir}'.  ${_report}")
    endif()
